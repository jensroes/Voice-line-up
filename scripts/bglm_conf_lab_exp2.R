...
# Save model
save(m,
     file="stanout/Exp2CONFBGLMNULL2000iter3chains.rda",
     compress="xz")
...
# Save model
save(m.acc,
     file="stanout/Exp2CONFBGLMacc2000iter3chains.rda",
     compress="xz")
...
# Save model
save(m.tp,
     file="stanout/Exp2CONFBGLMTP2000iter3chains.rda",
     compress="xz")
...
# Save model
save(m.serial,
     file="stanout/Exp2CONFBGLMserial2000iter3chains.rda",
     compress="xz")
...
compare(loo.m,loo.m.acc,loo.m.tp,loo.m.serial)


# Main effects model
m.tp.acc.serial <- update(m.tp, formula. = . ~ . + acc + serial)
save(m.tp.acc.serial,
     file="stanout/Exp2CONFBGLMTPaccserial2000iter3chains.rda",
     compress="xz")


# 2-way interactions
m.2.way.inter <- update(m.tp.acc.serial, formula. = . ~ . + acc : TP + acc : serial + serial : TP)
# Save model
save(m.2.way.inter,
     file="stanout/Exp2CONFBGLM2wayinters2000iter3chains.rda",
     compress="xz")


# 3-way interactions
m.3.way.inter <- update(m.2.way.inter, formula. = . ~ . + acc : TP : serial )
# Save model
save(m.3.way.inter,
     file="stanout/Exp2CONFBGLM3wayinters2000iter3chains.rda",
     compress="xz")
